...
/**
 * Foreground Service that uses FileObserver to monitor changes in the sync folder
 * and trigger syncs immediately.
 */
class FileMonitorService : Service() {
    ...
    private fun scheduleSync() {
        ...
        syncJob = scope.launch {
            try {
                DebugLogger.i("FileMonitorService", "Sync scheduled in ${SYNC_DEBOUNCE_MS}ms")
